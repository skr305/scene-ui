<template>
    ...
    >
        <span class="scene-number-input-divide" @click="decrease">-</span>
        <input 
            type='text'
            ref="input"
            :name='name'
        ...
        />
        <span class="scene-number-input-plus" @click="increase">+</span>
    </div>
</template>
